...
DB_CONFIG = {
    ...
    "port": int(os.getenv("DB_PORT", os.getenv("NPS_DB_PORT", 5432))),
...
LITELLM_CONFIG = {
    "api_key": os.getenv("LITELLM_API_KEY", os.getenv("LLM_KEY", "")),
    "model_name": os.getenv("LITELLM_MODEL_NAME", os.getenv("MODEL_NAME", "openai-gpt-5-mini")),
...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "/app/output_reports"))
